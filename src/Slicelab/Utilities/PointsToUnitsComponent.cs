...
{
    public class PointsToUnitsComponent : GH_Component
    {
        public PointsToUnitsComponent()
            : base("Points to Units", "SLFrPt",
                "Convert typographic points to length units. Supports MM, CM, Inches, and Feet. Auto-detects Rhino document units.",
                "Slicelab Tools", "Utilities")
        { }

        public override GH_Exposure Exposure => GH_Exposure.tertiary;
        public override Guid ComponentGuid => new Guid("735C3001-3337-4996-989C-629466D8A861");
        protected override Bitmap Icon => IconHelper.LoadIcon("SL-PtIn.png");
